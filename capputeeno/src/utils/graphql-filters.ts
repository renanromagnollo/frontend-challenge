...
export function getFieldByPriority(priority: PriorityTypes) {
    ...
    if(priority === PriorityTypes.BIGGEST_PRICE) return {field: "price_in_cent", order: "DSC"}
    if(priority === PriorityTypes.MINOR_PRICE) return {field: "price_in_cent", order: "ASC"}
